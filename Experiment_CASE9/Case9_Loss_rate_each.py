...
def main():
    ...
    expected_bandwidths = [0.53, 1.89, 0.83, 0.12, 0.45]
    error_margin = 0.05
    priority_ranges = {
        "Class A": (0.9, 1.0),
        "Class B": (0.7, 0.8),
    ...
    # RL Simulation
    env = TSNQoSEnv(traffic_df_copy_rl, n_clusters=num_clusters, initial_data_size=125, initial_bandwidth=104.35)
    ...
    avg_results_rl, rl_details = rl_simulation(env, agent, simulation_time, 104.35)
