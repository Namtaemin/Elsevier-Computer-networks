...
def run_case2_experiment(pre_trained_model_path):
    ...
    csv_file = '/home/scpa/Policy_DDS_TSN/sin/PPO-RL-base/Experiment_CASE7/Case7_experiment.csv'  # Case 2에 해당하는 데이터 파일
    ...
    plt.bar(class_names, sorted_allocation_ratios, color='yellow')
    plt.title('Initial Resource Allocation Ratios per Class for Case 3')
    plt.xlabel('Class')
...
def main():
    ...
    # Case 2 실험 실행
    print(f"\nStarting experiment for Case 7")
