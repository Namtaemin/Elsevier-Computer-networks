...
if Config.WRITER_FLAG:
    writer = SummaryWriter(log_dir='tensorboard/' + Config.WRITER_NAME)
...
def main():
    ...
    torch.save(agent.agent_control.policy_nn.state_dict(), '/home/scpa/Policy_DDS_TSN/sin/PPO-RL-base/Experiment_CASE7/trained_policy_model_After_Case7.pth')
    print("Trained model saved as 'trained_agent_model_Case7.pth'")
