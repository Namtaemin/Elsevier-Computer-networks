...
def main():
    ...
    torch.save(agent.agent_control.policy_nn.state_dict(), '/home/scpa/Policy_DDS_TSN/sin/PPO-RL-base/Experiment_CASE4/trained_policy_model_After_Case4.pth')
    print("Trained model saved as 'trained_agent_model_Case4.pth'")
