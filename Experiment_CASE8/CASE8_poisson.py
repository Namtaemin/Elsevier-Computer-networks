...
from EA_6_Class_env import TSNQoSEnv  # 환경 클래스 정의 필요
...
def visualize_results(allocated_bandwidth_ratios, loss_rates_per_time):
    ...
    plt.title("Case8: Loss Rate", fontsize=16)
...
def main():
    ...
    csv_file_path = "/home/scpa/Policy_DDS_TSN/sin/PPO-RL-base/Experiment_CASE8/traffic_scenario_case8.csv"
    traffic_df.to_csv(csv_file_path, index=False)

    # 환경 초기화
    env = TSNQoSEnv(traffic_df, n_clusters=6, initial_data_size=165, initial_bandwidth=84.35)

    # 모델 로드
    pre_trained_model_path = '/home/scpa/Policy_DDS_TSN/sin/PPO-RL-base/Experiment_CASE8/trained_policy_model_Case8.pth'
