...
def analyze_and_visualize(avg_results_rl, avg_results_dnn, avg_results_pq, priority_ranges):
    ...
    plt.title("Case8: Average Allocated Bandwidth Ratio (RL, DNN, PQ)")
    plt.xlabel("Class")
...
def main():
    ...
    lambdas = [40, 40, 40, 20, 15, 10]
    payload_sizes = [500, 400, 300, 200, 600, 700]
    expected_bandwidths = [0.53, 1.89, 0.43, 0.12, 0.24, 0.05]
    error_margin = 0.05
    priority_ranges = {
        "Class A": (0.9, 1.0),
        "Class B": (0.6, 0.7),
    ...
    env = TSNQoSEnv(traffic_df_copy_rl, n_clusters=num_clusters, initial_data_size=165, initial_bandwidth=batch_bandwidth)
    agent = Agent(15, action_size=Config.ACTION_SIZE, batch_size=Config.BATCH_SIZE)
    rl_model_path = '/home/scpa/Policy_DDS_TSN/sin/PPO-RL-base/Experiment_CASE7/trained_policy_model_Case7.pth'
    ...
    dnn_model_path = '/home/scpa/Policy_DDS_TSN/sin/DNN_regression/Experiment_CASE2/DNN_Class6.h5'
