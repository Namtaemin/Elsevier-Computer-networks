...
def main():
    ...
    # RL Simulation
    env = TSNQoSEnv(traffic_df_copy_rl, n_clusters=num_clusters, initial_data_size=165, initial_bandwidth=96)
    ...
    avg_results_rl, rl_details = rl_simulation(env, agent, simulation_time, 96)

    # DNN Simulation
    dnn_model = load_model('/home/scpa/Policy_DDS_TSN/sin/DNN_regression/Experiment_CASE2/DNN_Class62.h5')
