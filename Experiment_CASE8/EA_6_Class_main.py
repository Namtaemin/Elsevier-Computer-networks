...
def main():
    ...
    torch.save(agent.agent_control.policy_nn.state_dict(), '/home/scpa/Policy_DDS_TSN/sin/PPO-RL-base/Experiment_CASE2/trained_policy_model_After_Case2.pth')
    print("Trained model saved as 'trained_agent_model_Case2.pth'")
