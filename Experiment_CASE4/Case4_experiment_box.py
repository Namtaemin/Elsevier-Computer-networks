...
def main():
    pre_trained_model_path = '/home/scpa/Policy_DDS_TSN/sin/PPO-RL-base/Experiment_CASE4/trained_policy_model_Case7.pth'
    ...
    plt.title(f'Case2-1 Resource Allocation Ratios with Min/Max/Median')
