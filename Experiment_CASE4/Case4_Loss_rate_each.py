...
def main():
    ...
    # RL Simulation
    env = TSNQoSEnv(traffic_df_copy_rl, n_clusters=num_clusters, initial_data_size=80, initial_bandwidth=65)
    ...
    avg_results_rl, rl_details = rl_simulation(env, agent, simulation_time, 65)
