...
def visualize_results(allocated_bandwidth_ratios, loss_rates_per_time):
    ...
    plt.title("Case4: Loss Rate", fontsize=16)
...
def main():
    ...
    is_zero_bandwidth = [False, False, False]  # Class F의 대역폭은 항상 0
    ...
    # 환경 초기화
    env = TSNQoSEnv(traffic_df, n_clusters=3, initial_data_size=80, initial_bandwidth=80)
