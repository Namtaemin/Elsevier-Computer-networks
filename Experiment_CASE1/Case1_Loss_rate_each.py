...
def analyze_loss_and_visualize(avg_results_rl, avg_results_dnn, avg_results_pq, rl_details, dnn_details, pq_details):
    ...
    # 박스플롯 생성
    box_plot = plt.boxplot(loss_rate_data, labels=algorithm_labels, patch_artist=True,
...
def main():
    ...
    # RL Simulation
    env = TSNQoSEnv(traffic_df_copy_rl, n_clusters=num_clusters, initial_data_size=100, initial_bandwidth=78)
    ...
    avg_results_rl, rl_details = rl_simulation(env, agent, simulation_time, 78)
