...
def run_case1_experiment(pre_trained_model_path):
    ...
    env = TSNQoSEnv(dataset, n_clusters=3, initial_data_size=33, initial_bandwidth=132)
    ...
    if os.path.exists(pre_trained_model_path):
        ...
        print(f"No pre-trained model found at '{pre_trained_model_path}', starting from scratch for Case 1-1")
        return None
