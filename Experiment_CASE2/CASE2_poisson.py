...
def visualize_results(allocated_bandwidth_ratios, loss_rates_per_time):
    ...
    plt.title("Case2: Loss Rate", fontsize=16)
...
def main():
    ...
    csv_file_path = "/home/scpa/Policy_DDS_TSN/sin/PPO-RL-base/Experiment_CASE2/traffic_scenario_case2.csv"
    traffic_df.to_csv(csv_file_path, index=False)

    # 환경 초기화
    env = TSNQoSEnv(traffic_df, n_clusters=6, initial_data_size=190, initial_bandwidth=149.765)
