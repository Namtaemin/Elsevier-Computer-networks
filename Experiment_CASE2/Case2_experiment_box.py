...
def main():
    ...
    num_experiments = 10
    all_runs_ratios = {'class_0': [], 'class_1': [], 'class_2': [], 'class_3': [], 'class_4': [], 'class_5': []}  # 클래스별 할당 비율 저장
    all_class_priorities = {'class_0': [], 'class_1': [], 'class_2': [], 'class_3': [], 'class_4': [], 'class_5': []}  # 클래스별 우선순위 저장
    ...
    plt.title(f'Case1-2 Resource Allocation Ratios with Min/Max/Median')    
