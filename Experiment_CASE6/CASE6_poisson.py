...
def visualize_results(allocated_bandwidth_ratios, loss_rates_per_time):
    ...
    plt.title("Case6: Loss Rate", fontsize=16)
...
def main():
    ...
    csv_file_path = "/home/scpa/Policy_DDS_TSN/sin/PPO-RL-base/Experiment_CASE6/traffic_scenario_case6.csv"
    traffic_df.to_csv(csv_file_path, index=False)

    # 환경 초기화
    env = TSNQoSEnv(traffic_df, n_clusters=3, initial_data_size=85, initial_bandwidth=80)

    # 모델 로드
    pre_trained_model_path = '/home/scpa/Policy_DDS_TSN/sin/PPO-RL-base/Experiment_CASE6/trained_policy_model_After_Case6.pth'
