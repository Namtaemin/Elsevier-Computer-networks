...
def run_case2_experiment(pre_trained_model_path):
    ...
    csv_file = '/home/scpa/Policy_DDS_TSN/sin/PPO-RL-base/Experiment_CASE6/Case6_experiment.csv'  # Case 2에 해당하는 데이터 파일
    dataset = pd.read_csv(csv_file)
    

    env = TSNQoSEnv(dataset, n_clusters=3, initial_data_size=114, initial_bandwidth=350)  # 초기 데이터 수를 33으로 설정
    ...
    plt.title('Initial Resource Allocation Ratios per Class for Case 2-3')
    plt.xlabel('Class')
...
def main():
    ...
    # Case 2 실험 실행
    print(f"\nStarting experiment for Case 6")
